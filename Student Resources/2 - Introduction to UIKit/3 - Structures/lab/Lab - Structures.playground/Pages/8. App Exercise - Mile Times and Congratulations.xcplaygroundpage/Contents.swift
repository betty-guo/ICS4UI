...
var temp1 = RunningWorkout(distance: 1600, time: 2, elevation: 1)
print (temp1.averageMileTime)
/*:
...
struct Steps {
    var steps: Int{
        willSet{
            if newValue == goal{
                print ("Good job! You've beat your goal!")
            }
        }
    }
    var goal: Int
...
var temp2 = Steps(steps: 9999, goal: 10000)
temp2.takeStep()
