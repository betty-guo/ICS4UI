...
var favoriteBook = Book(title: "Hi", author: "hi", pages: 1, price: 12)
print ("\(favoriteBook.title) by \(favoriteBook.author) is \(favoriteBook.pages) pages and costs \(favoriteBook.price)")
/*:
