...
struct User {
    ...
    var email: String
    var age: Int
    static var currentUser: User = User(userName: "Betty", email: "betty@gmail.com", age: 16)
    static func logIn(user: User){
        currentUser = user
        print ("The user \(currentUser.userName) has logged in")
    }
}
 ...
 */
var temp3 = User(userName: "NotBetty", email: "notbetty@gmail.com", age: 18)
User.logIn(user: temp3)
